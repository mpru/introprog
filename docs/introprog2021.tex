...
\caption{Correr el programa de R desde la consola en Linux}\label{fig:unnamed-chunk-136}
\end{figure}
...
\caption{Programa paridad.R}\label{fig:unnamed-chunk-138}
\end{figure}
...
\caption{Programa salario.R}\label{fig:unnamed-chunk-140}
\end{figure}
...
\caption{Programa suma.R}\label{fig:unnamed-chunk-143}
\end{figure}
