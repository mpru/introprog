...
\caption{Correr el programa de R desde la consola en Linux}\label{fig:unnamed-chunk-159}
\end{figure}
...
\caption{Programa paridad.R}\label{fig:unnamed-chunk-161}
\end{figure}
...
\caption{Programa salario.R}\label{fig:unnamed-chunk-163}
\end{figure}
...
\caption{Programa suma.R}\label{fig:unnamed-chunk-166}
\end{figure}
