...
\caption{Ejemplo de una lista}\label{fig:unnamed-chunk-132}
\end{figure}
...
\caption{La lista en la pestaña Environment de RStudio}\label{fig:unnamed-chunk-134}
\end{figure}
...
\caption{Ejemplo de una lista}\label{fig:unnamed-chunk-135}
\end{figure}
...
\caption{Bosquejo de las estructuras de datos necesarias}\label{fig:unnamed-chunk-155}
\end{figure}
...
\caption{Programa paridad.R.}\label{fig:unnamed-chunk-184}
\end{figure}
...
\caption{Programa salario.R.}\label{fig:unnamed-chunk-186}
\end{figure}
...
\caption{Programa suma.R.}\label{fig:unnamed-chunk-188}
\end{figure}
