...
\begin{verbatim}
Error in eval(expr, envir, enclos): objeto 'z' no encontrado
\end{verbatim}
...
\begin{verbatim}
Error in f(4): el argumento "y" está ausente, sin valor por omisión
\end{verbatim}
...
\begin{verbatim}
Error in nueva_f(): el argumento "x" está ausente, sin valor por omisión
\end{verbatim}
...
\begin{verbatim}
Error in nueva_f(y = 5): el argumento "x" está ausente, sin valor por omisión
\end{verbatim}
