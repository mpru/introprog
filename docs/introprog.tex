...
\caption{Ejemplo de un vector numérico}\label{fig:unnamed-chunk-101}
\end{figure}
...
\caption{Ejemplo de un vector numérico: índices para señalar cada posición.}\label{fig:unnamed-chunk-102}
\end{figure}
...
\caption{Ejemplo de un vector caracter y un vector lógico}\label{fig:unnamed-chunk-103}
\end{figure}
...
\caption{Creación de vectores en R}\label{fig:unnamed-chunk-105}
\end{figure}
...
\caption{Ejemplo de una matriz numérica}\label{fig:unnamed-chunk-112}
\end{figure}
...
\caption{Ejemplo de una matriz numérica: índices para señalar cada posición}\label{fig:unnamed-chunk-113}
\end{figure}
...
\caption{Recorrer una matriz por fila}\label{fig:unnamed-chunk-118}
\end{figure}
...
\caption{Recorrer una matriz por columna}\label{fig:unnamed-chunk-120}
\end{figure}
...
\caption{Matriz traspuesta}\label{fig:unnamed-chunk-122}
\end{figure}
...
\caption{Ejemplo de una lista}\label{fig:unnamed-chunk-127}
\end{figure}
...
\caption{La lista en la pestaña Environment de RStudio}\label{fig:unnamed-chunk-129}
\end{figure}
...
\caption{Ejemplo de una lista}\label{fig:unnamed-chunk-130}
\end{figure}
...
\caption{Primeros registros del archivo reservas.txt}\label{fig:unnamed-chunk-144}
\end{figure}
...
\caption{Bosquejo de las estructuras de datos necesarias}\label{fig:unnamed-chunk-150}
\end{figure}
...
\caption{Abrir la terminal en Windows. En computadoras con Windows en español, en lugar de Command Prompt dice Símbolo del sistema.}\label{fig:unnamed-chunk-170}
\end{figure}
...
\caption{Línea de comandos de Windows.}\label{fig:unnamed-chunk-171}
\end{figure}
...
\caption{Contenido del directorio actual (Windows).}\label{fig:unnamed-chunk-172}
\end{figure}
...
\caption{Carpeta en la cual deseamos trabajar.}\label{fig:unnamed-chunk-173}
\end{figure}
...
\caption{Cambio de directorio de trabajo y listado de archivos en el mismo.}\label{fig:unnamed-chunk-174}
\end{figure}
...
\caption{Abrir la terminal desde una carpeta en particular en Windows.}\label{fig:unnamed-chunk-175}
\end{figure}
...
\caption{Correr el programa de R desde la consola en Windows.}\label{fig:unnamed-chunk-177}
\end{figure}
...
\caption{Programa paridad.R.}\label{fig:unnamed-chunk-179}
\end{figure}
...
\caption{Programa salario.R.}\label{fig:unnamed-chunk-181}
\end{figure}
...
\caption{Programa suma.R.}\label{fig:unnamed-chunk-183}
\end{figure}
