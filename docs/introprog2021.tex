...
\caption{Ejemplo de una matriz numérica}\label{fig:unnamed-chunk-102}
\end{figure}
...
\caption{Ejemplo de una matriz numérica: índices para señalar cada posición}\label{fig:unnamed-chunk-103}
\end{figure}
...
\caption{Recorrer una matriz por fila}\label{fig:unnamed-chunk-108}
\end{figure}
...
\caption{Recorrer una matriz por columna}\label{fig:unnamed-chunk-110}
\end{figure}
...
\caption{Matriz traspuesta}\label{fig:unnamed-chunk-112}
\end{figure}
...
\caption{Ejemplo de una lista}\label{fig:unnamed-chunk-117}
\end{figure}
...
\caption{La lista en la pestaña Environment de RStudio}\label{fig:unnamed-chunk-119}
\end{figure}
...
\caption{Ejemplo de una lista}\label{fig:unnamed-chunk-120}
\end{figure}
