...
\caption{Bosquejo de las estructuras de datos necesarias}\label{fig:unnamed-chunk-141}
\end{figure}
...
\caption{Correr el programa de R desde la consola en Linux}\label{fig:unnamed-chunk-162}
\end{figure}
...
\caption{Programa paridad.R}\label{fig:unnamed-chunk-164}
\end{figure}
...
\caption{Programa salario.R}\label{fig:unnamed-chunk-166}
\end{figure}
...
\caption{Programa suma.R}\label{fig:unnamed-chunk-169}
\end{figure}
