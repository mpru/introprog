...
\caption{Programa paridad.R.}\label{fig:unnamed-chunk-178}
\end{figure}
...
\caption{Programa salario.R.}\label{fig:unnamed-chunk-180}
\end{figure}
...
\caption{Programa suma.R.}\label{fig:unnamed-chunk-182}
\end{figure}
