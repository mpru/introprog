...
En el \textbf{ejercicio 3} de la \textbf{Práctica 4} creamos las funciones \texttt{ordenar\_asc()} y \texttt{ordenar\_des()} para ordenar los elementos de un vector. Con las funciones disponibles en R, ssto se puede hacer así:
...
\caption{Abrir la terminal en Windows. En computadoras con Windows en español, en lugar de Command Prompt dice Símbolo del sistema.}\label{fig:unnamed-chunk-196}
\end{figure}
...
\caption{Línea de comandos de Windows.}\label{fig:unnamed-chunk-197}
\end{figure}
...
\caption{Contenido del directorio actual (Windows).}\label{fig:unnamed-chunk-198}
\end{figure}
...
\caption{Carpeta en la cual deseamos trabajar.}\label{fig:unnamed-chunk-199}
\end{figure}
...
\caption{Cambio de directorio de trabajo y listado de archivos en el mismo.}\label{fig:unnamed-chunk-200}
\end{figure}
...
\caption{Abrir la terminal desde una carpeta en particular en Windows.}\label{fig:unnamed-chunk-201}
\end{figure}
...
\caption{Correr el programa de R desde la consola en Windows.}\label{fig:unnamed-chunk-203}
\end{figure}
...
\caption{Programa paridad.R.}\label{fig:unnamed-chunk-205}
\end{figure}
...
\caption{Programa salario.R.}\label{fig:unnamed-chunk-207}
\end{figure}
...
\caption{Programa suma.R.}\label{fig:unnamed-chunk-209}
\end{figure}
